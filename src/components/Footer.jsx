    ...
    <footer className="bg-gray-100 text-gray-700 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm">
            We offer timeless jewelry crafted with love. Every piece tells a story and reflects the beauty of life.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mb-2">parakh jewellers sadar bazar, raipur c.g</p>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-xl">
            ...
            <a href="#" className="hover:text-gray-900"><FaPinterest /></a>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 text-center py-4 text-sm text-gray-500">
        © {new Date().getFullYear()} GemGlow Jewelry. All rights reserved.
      </div>
    </footer>
  );
}
